...
describe('BetterBayClient', () => {
    ...
    describe('Buy API', () => {
        ...
        test('Get cheapest item, multiple item groups', () => {
            ...
            return response.then(cheapestItems => {
                ...
                expect(cheapestItem1.description["COLOURS"]).toEqual("Royal Mail will deliver your ORDER")
    ...
    describe('Developer API', () => {
        ...
        test('Health Check', () => {
            const response: Promise<Record<string, BetterBayLimit>> = client.healthCheck();
